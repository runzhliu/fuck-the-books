...
对书名有兴趣的同学，可以点击跳转到京东查看书本的版号和详细的目录，再决定要不要这本书，由于手残，可能会有误，有发现不对的情况可以联系我哈。

如果已经有同学联系过我要的书，我会在「送出」那一栏标记 :heavy_check_mark: 

### 教科书类书籍

|书名|介绍|书本情况|送出|其他|
|:---|:---|:---|:---|
|[Java程序设计实验指导](https://item.jd.com/11203735.html)|适合刚接触Java的同学|完好|||
|[计算机组成原理(第2版)](https://item.jd.com/12271404.html)||完好|||
